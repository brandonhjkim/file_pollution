...
```{r}
20.47375*obs1[1,1]+0.1161389*obs1[1,2]-0.09341959*obs1[1,3]+0.06391368*obs1[1,4]-116.6708 
```

L2:

```{r}
19.89371*obs1[1,1]+0.2146811*obs1[1,2]-0.11154897*obs1[1,3]+0.07789059*obs1[1,4]-111.0938 # L2 
```

L3: 

```{r}
19.30087*obs1[1,1]+0.3883845*obs1[1,2]-0.11797003*obs1[1,3]+0.09583682*obs1[1,4]-108.3684 # L3 
```
